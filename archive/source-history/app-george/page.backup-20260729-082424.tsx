...
<div className={`${(forceLive || liveMode)
  ...
  : 'fixed inset-x-0 bottom-[max(16px,env(safe-area-inset-bottom))] md:bottom-[112px]'} ${
    (forceLive || liveMode) && liveReceiverProfile === 'audio_only'
      ? 'hidden'
      : ''
                    ...
                    <div className={`george-composer-shell relative z-[191] isolate flex-1 overflow-hidden rounded-[1.5rem] border pointer-events-auto touch-manipulation shadow-[0_12px_38px_rgba(4,10,28,0.46)] ${!(forceLive || liveMode) ? 'border-[#4668B8]/65 !bg-[#101A36] shadow-[0_0_34px_rgba(8,18,48,0.48)]' : 'border-[#2B457F]/48 bg-[#101A36]'}`}>
