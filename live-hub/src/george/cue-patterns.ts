...
export const GEORGE_CUE_PATTERNS: CuePattern[] = [
  ...
  {
    category: 'objection',
    pattern: /\b(not interested|concerned|skeptical|hesitant|risk|disagree|pushback|doesn't solve|does not solve|won't work|will not work)\b/i,
    cue: 'Address the objection directly.',
  ...
  },
  {
    ...
    pattern: /\b(what do you mean|can you clarify|please clarify|unclear what you mean|i don't understand|i do not understand)\b/i,
    cue: 'Clarify the specific point.',
    reason: 'Explicit clarification request detected.',
    confidence: 0.74,
    priority: 50,
  },
  {
