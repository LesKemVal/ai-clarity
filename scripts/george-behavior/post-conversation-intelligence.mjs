...
export function run() {
  ...
  const report = summarizeConversationIntelligence({
    ...
    transcript: [
      ...
      {
        speaker:'other_party',
        text:'I like the concept but I need proof customers will actually use it.'
      },

      {
        speaker:'user',
        text:'We have several pilot opportunities beginning next month.'
      },

      {
        speaker:'other_party',
        text:'Send me the pilot results once you have them.'
      },
  ...
  assert(
    /second investor meeting/i.test(
