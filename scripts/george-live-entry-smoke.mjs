...
const checks = [
  ...
  ['Popup 3 includes a briefing-compatible confident approach', liveEntry.includes("label: 'Confident and prepared'")],
  ...
  ['Popup 3 asks the user to choose an approach', liveEntry.includes('Choose your approach')],
  ['Popup 3 explains LIVE control orientation', liveEntry.includes('These controls will be available in the conversation.')],
  ['Popup 3 explains briefing-filtered approach choices', liveEntry.includes('GEORGE filtered these choices using the full briefing.')],
  ['LIVE setup carries intangibleObjective', liveEntry.includes('intangibleObjective,')],
  ['LIVE setup carries fallbackOutcome', liveEntry.includes('fallbackOutcome: secondaryOutcome')],
