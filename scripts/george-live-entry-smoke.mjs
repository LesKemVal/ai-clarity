...
const checks = [
  ...
  ['Popup 3 asks if anything else remains', liveEntry.includes('Is there anything else?')],
  ['Popup 3 explains natural speech', liveEntry.includes('Talk naturally to everyone else.')],
  ['Popup 3 explains adaptation', liveEntry.includes("I'll adapt my support while we're live.")],
