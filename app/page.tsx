    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto max-w-5xl px-6 pb-14 pt-[118px] sm:px-8 sm:pt-[132px]">
        ...
        <section className="border-b border-white/[0.08] py-10 sm:py-12">
          ...
          <h2 className="mt-4 max-w-4xl text-[31px] font-medium leading-[1.08] tracking-[-0.035em] text-white sm:text-[42px]">Start from your role in the discussion.</h2>
          <p className="mt-4 max-w-[46rem] font-mono text-[14px] leading-7 text-white/46">Choose your role and the kind of conversation you are preparing for. GEORGE shapes support around your objective, position, risks, and pressure points.</p>
        ...
        <section className="border-b border-white/[0.08] py-10 sm:py-12">
          ...
          <h2 className="mt-4 max-w-4xl text-[31px] font-medium leading-[1.08] tracking-[-0.035em] text-white sm:text-[42px]">Build the room before you enter it.</h2>
          <p className="mt-4 max-w-[46rem] font-mono text-[14px] leading-7 text-white/46">Brief GEORGE step by step on the outcome, participants, known context, support mechanics, and readiness before entering LIVE.</p>
        ...
        <section className="border-b border-white/[0.08] py-10 sm:py-12">
          ...
          <h2 className="mt-4 max-w-4xl text-[31px] font-medium leading-[1.08] tracking-[-0.035em] text-white sm:text-[42px]">Work through the situation first. Bring the work with you.</h2>
          <p className="mt-4 max-w-[46rem] font-mono text-[14px] leading-7 text-white/46">Think, prepare, decide, write, rehearse, compare options, or work through uncertainty before moving into LIVE.</p>
        ...
        <section className="border-b border-white/[0.08] py-10 sm:py-12">
          ...
          <h2 className="mt-4 max-w-4xl text-[31px] font-medium leading-[1.08] tracking-[-0.035em] text-white sm:text-[42px]">Understand the routes before you choose one.</h2>
          <p className="mt-4 max-w-[46rem] font-mono text-[14px] leading-7 text-white/46">See how Normal GEORGE, Role First, Traditional LIVE, support mechanics, and LIVE execution fit together.</p>
        ...
        <section className="border-b border-white/[0.08] py-10 sm:py-12">
          ...
          <h1 className="mt-5 max-w-4xl text-[42px] font-medium leading-[1.02] tracking-[-0.05em] text-white sm:text-[60px]">Know what matters. Know what to do next.</h1>
        ...
        <section className="border-b border-white/[0.08] py-10 sm:py-12">
          ...
          <div className="mt-5 font-mono text-[18px] leading-8 tracking-[-0.02em] text-white/76 sm:text-[21px]">Context → Assessment → Strategy → Execution → Learning</div>
