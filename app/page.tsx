...
export default function RootPage() {
  return (
    <main className="relative flex min-h-[100dvh] items-center justify-center overflow-hidden bg-[#06070A] px-5 py-8 text-white">
      <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(180deg,#08101A_0%,#06070A_46%,#050609_100%)]" />
      <div className="pointer-events-none absolute inset-x-0 top-0 h-px bg-white/[0.045]" />

      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute inset-0 bg-[linear-gradient(180deg,rgba(13,38,62,0.44),rgba(10,24,38,0.30)_36%,rgba(6,7,10,0.52)_70%,rgba(6,7,10,0.92)_100%)]" />
        <div className="absolute left-1/2 top-[-90px] h-[92%] w-[1180px] -translate-x-1/2 overflow-hidden rounded-[1.8rem] bg-[linear-gradient(105deg,rgba(10,18,31,0.36),rgba(29,75,102,0.24)_44%,rgba(7,10,17,0.30))] opacity-76">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_32%,rgba(174,182,255,0.085),transparent_24%),radial-gradient(circle_at_74%_30%,rgba(126,201,218,0.065),transparent_18%),radial-gradient(circle_at_38%_66%,rgba(29,75,102,0.18),transparent_28%)]" />
          <div className="absolute left-[6%] top-[148px] h-px w-[84%] bg-gradient-to-r from-transparent via-[#9BB8CF]/16 to-transparent" />
          <div className="absolute left-[12%] top-[248px] h-px w-[72%] bg-gradient-to-r from-transparent via-[#AEB6FF]/11 to-transparent" />
          ...
          <div className="absolute left-[18%] top-[168px] h-2 w-2 rounded-[0.25rem] bg-[#AEB6FF]/10" />
          <div className="absolute left-[42%] top-[238px] h-2.5 w-2.5 rounded-[0.3rem] bg-[#8FB6C9]/10" />
          <div className="absolute left-[63%] top-[164px] h-3 w-3 rounded-[0.35rem] bg-[#7EC9DA]/8" />
