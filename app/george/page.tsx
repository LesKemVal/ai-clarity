                                  ...
                                  <div className="pr-12">
                                    ...
                                    <button
                                      ...
                                      onClick={() => {
                                        ...
                                        setToastMessage(
                                          false
                                            ? "LIVE sessions cleared."
                                            : "LIVE conversations cleared.",
                                        );
                                        setShowToast(true);
                                      }}
                                  ...
                                  {(() => {
                                    ...
                                    try {
                                      sessions = getSessionsForMode("live")
                                        ...
                                        .sort((a, b) => {
                                          const activeId =
                                            getActiveSessionIdForMode("live");
                                          ...
                                          <button
                                            onClick={() => {
                                              ...
                                              const restart =
                                                ...
                                                "Continue from the strongest next move, or tell me what changed.";
...
Continue from here, tell me what changed, or start fresh.`,
                                              ...
                                              const smartResumeEntry: Message =
                                                restartBrief;
                                              ...
                                              setToastMessage(
                                                `${session.title || "Conversation"} restored.`,
                                              );
                                              setShowToast(true);
                                            }}
                                          ...
                                          >
                                            <div className="flex items-start justify-between gap-3">
                                              ...
                                              <span
                                                className={`shrink-0 rounded-full px-1.5 py-0.5 text-[9px] font-semibold tracking-[0.14em] ${
                                                  sessionPickerMode ===
                                                  "campaign"
...
`}</style>
                ...
                {false && liveMode && stableLiveGuidance && (
                  <div
                    className={`${forceLive || liveMode ? "hidden" : "fixed"} bottom-[118px] left-0 right-0 z-[88] mx-auto flex w-full max-w-[900px] justify-center px-4`}
                  >
                    <div className="w-full max-w-[420px] md:max-w-[720px] xl:max-w-[920px] md:max-w-[720px] xl:max-w-[920px] md:max-w-[420px] md:max-w-[720px] xl:max-w-[920px] xl:max-w-[760px] rounded-[0.9rem] border border-white/[0.05] bg-white/[0.02] px-3 py-2.5 md:px-5 md:py-4 md:px-5 md:py-4 -[10px]">
                      ...
                      {outcomeGovernorSnapshot && (
                        <div
                          className={`${stableLiveGuidance ? "mt-2 border-t border-white/[0.055] pt-2" : ""}`}
                        >
                ...
                {false && liveMode && (
                  <div
                    className={`${forceLive || liveMode ? "hidden" : "fixed"} bottom-[72px] left-0 right-0 z-[90] mx-auto flex w-full max-w-[900px] justify-center px-4`}
                  >
                    <div className="relative flex items-center justify-center gap-6">
                      ...
                      >
                        <span
                          className={`h-1.5 w-1.5 rounded-full ${voiceOn ? "bg-[#8FB6C9]/70 shadow-[0_0_10px_rgba(143,182,201,0.28)]" : "bg-white/24"}`}
                        />
                        {voiceOn ? "MUTE" : "UNMUTE"}
                      </button>
                      ...
                      {showLiveQuickMenu && (
                        <>
                          ...
                          <div
                            data-george-language-menu
                            className={`absolute bottom-full left-1/2 z-[90] mb-3 w-[220px] -translate-x-1/2 px-3 py-2.5 md:px-5 md:py-4 md:px-5 md:py-4 ${operationalMotion.anchorPanel} ${operationalMotion.surface}`}
                          >
                            <div className="mb-2 flex items-center justify-between gap-3">
                              <div className="text-[9px] uppercase tracking-[0.22em] text-white/24">
                                LIVE
