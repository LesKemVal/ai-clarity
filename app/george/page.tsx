            ...
            >
              ...
              >
                  ...
                  <div className="flex items-center gap-4 py-3 text-[#D7DBE4]/80 text-[13px]">
                    <div className="relative flex items-center gap-2">
                      ...
                      {showProLiveComingSoon &&
                        ...
                        createPortal(
                          <StructuredLiveNotice
                            onClose={() => setShowProLiveComingSoon(false)}
                          />,
                          document.body,
                        )}
                      ...
                      {showLiveSessionDetails &&
                        typeof document !== "undefined" &&
                        createPortal(
                          <LiveSessionDetailsPanel
                            receiverLabel={activeLiveReceiverProfileLabel}
                            communicationStyle={getActiveLiveCommunicationStyle()}
                            voiceOn={voiceOn}
                            liveRoomActive={liveRoomActive}
                            room={liveRuntimeSupport?.room}
                            role={
                              liveRuntimeSupport?.chair ||
                              liveRuntimeSupport?.userPosition
                            }
                            outcome={liveRuntimeSupport?.objective}
                            secondaryOutcome={
                              liveRuntimeSupport?.secondaryOutcome ||
                              liveRuntimeSupport?.secondaryObjective
                            }
                            onClose={() => setShowLiveSessionDetails(false)}
                          />,
                          document.body,
                        )}
                      ...
                      {showOutcomeExitReview &&
                        ...
                        typeof document !== "undefined" &&
                        createPortal(
                          <LiveOutcomeReviewPanel
                            observation={liveOutcomeReview}
                            onChange={(next) => setLiveOutcomeReview(next)}
                            onClose={() => setShowOutcomeExitReview(false)}
                            onAccept={finishLiveExitAfterOutcomeReview}
                            onContinue={() => {
                              setShowOutcomeExitReview(false);
                              setPendingLiveExitAction(null);
                            }}
                ...
                >
                  ...
                  <div
                    className={`george-composer-shell relative z-[191] isolate flex-1 overflow-hidden rounded-[1.5rem] border pointer-events-auto touch-manipulation ${
                      forceLive || liveMode
...
Tell me what this is, what matters most, and how GEORGE can help me use it effectively.`;
        ...
        {showTierModal &&
          ...
          createPortal(
            <TierAccessPanel
              headline={tierUpgradeAction.headline}
              currentLabel={tierUpgradeAction.currentLabel}
              currentIncludes={tierUpgradeAction.currentIncludes}
              nextCopy={tierUpgradeAction.nextCopy}
              cta={tierUpgradeAction.cta}
              onUpgrade={() => {
