...
import { LiveOrientationIcon, type LiveOrientationIconKind } from '@/components/george/live-entry/LiveOrientationIcon'
        ...
        >
          <div className="mt-3 space-y-3">
            ...
            <LiveReceiverProfilePanel
              ...
              onToggle={() =>
                setLiveBriefingOpenMechanicsPanel(
                  liveBriefingOpenMechanicsPanel === 'receiver' ? null : 'receiver'
                )
              }
