...
Conversation Packages organize work.
...
Relevant Documentation belongs to the active user.

Documents uploaded during Normal or LIVE may become available to GEORGE for that same user when they materially improve reasoning.

GEORGE does not distinguish between Normal documents and LIVE documents for ownership.

Operating mode determines execution, not information ownership.
